...
<tr>
	...
	<tr>
		...
		<br><h2 align="center">New Customers:</h2>
		<p><h4>By creating an account , you will be able to move through the checkout process faster, store multiple shipping addresses,
			view faster and tract your orders in your account and more.</h4></p>
<form   action="create.html" >
	<input type="button" id= "input1" name="" onclick="Create()" value="Create an Account">
		...
		<table>
			<tr>
				<td>Password:</td>
				<td><input type="password" name="psw" value="" placeholder="email" width="500px"><br></td>
			</tr>
		<tr>
			<td>Confirm Password:</td>
			<td><input type="Password" name="" value="" placeholder="password" width="500px"><br></td>
		</tr>
			<tr>
				<td><input type="button" name=""  value="Login"></td>
			</tr>
